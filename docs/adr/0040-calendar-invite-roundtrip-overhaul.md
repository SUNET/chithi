...
### Negative
- `auto_process_calendar_emails` during sync requires body prefetch (not yet implemented — envelope-only sync doesn't fetch bodies). Currently invite processing happens on email open.
