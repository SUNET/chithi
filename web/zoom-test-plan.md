...
2. A mail and calendar account the reviewer already uses. Any of the
   ...
   calendar event:
   - A Gmail account (OAuth or app password).
   - A Microsoft 365 / Outlook account (OAuth).
...
- **Gmail:** click "Add Gmail account", complete Google's OAuth flow in
  the system browser, return to Chithi.
- **Microsoft 365:** click "Add Microsoft account", complete the
  Microsoft OAuth flow.
- **Generic IMAP / CalDAV:** click "Add IMAP account", enter server,
